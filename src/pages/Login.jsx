        ...
        <div className="z-[5] flex flex-col items-center justify-start text-white login-container h-screen ">
            ...
            <form onSubmit={handleSubmit} className=" max-w-md login-form">
                ...
                >
                    ...
                    {/* gradient start */}
          <div className="absolute block sm:hidden z-[0] top-0 right-0 w-[30%] h-[50%] rounded-full white__gradient" />
          <div className="absolute block sm:hidden z-[0] w-[50%] h-[50%] -left-1/2 bottom-0 rounded-full pink__gradient" />
          {/* gradient end */}
        </div>
