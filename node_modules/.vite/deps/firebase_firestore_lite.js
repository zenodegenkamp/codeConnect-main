...
var __PRIVATE_QueryImpl = class {
  ...
  constructor(t, e = null, r = [], n = [], i = null, s = "F", o = null, a = null) {
    this.path = t, this.collectionGroup = e, this.explicitOrderBy = r, this.filters = n, this.limit = i, this.limitType = s, this.startAt = o, this.endAt = a, this.q = null, // The corresponding `Target` of this `Query` instance.
...
function __PRIVATE_queryToTarget(t) {
  ...
  if (!e.B)
    if ("F" === e.limitType)
      e.B = __PRIVATE_newTarget(e.path, e.collectionGroup, __PRIVATE_queryOrderBy(e), e.filters, e.limit, e.startAt, e.endAt);
    else {
      const t2 = [];
      for (const r2 of __PRIVATE_queryOrderBy(e)) {
        const e2 = "desc" === r2.dir ? "asc" : "desc";
        t2.push(new OrderBy(r2.field, e2));
      }
      ...
      e.B = __PRIVATE_newTarget(e.path, e.collectionGroup, t2, e.filters, e.limit, r, n);
    }
  return e.B;
}
...
var __PRIVATE_DatastoreImpl = class extends class Datastore {
  ...
  R(t, e, r) {
    return this.X(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([n, i]) => this.connection.R(t, e, r, n, i)).catch((t2) => {
  ...
  g(t, e, r, n) {
    return this.X(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([i, s]) => this.connection.g(t, e, r, i, s, n)).catch((t2) => {
      throw "FirebaseError" === t2.name ? (t2.code === p && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), t2) : new FirestoreError(A, t2.toString());
    });
  }
  terminate() {
...
async function __PRIVATE_invokeRunAggregationQueryRpc(t, e, r) {
  var n;
  const i = __PRIVATE_debugCast(t), { request: s, tt: o } = function __PRIVATE_toRunAggregationQueryRequest(t2, e2, r2) {
...
var __PRIVATE_ParseContextImpl = class ___PRIVATE_ParseContextImpl {
  ...
  lt(t) {
    return __PRIVATE_createError(t, this.settings.methodName, this.settings.ct || false, this.path, this.settings.ht);
  }
  ...
  ot(t) {
    ...
    if (__PRIVATE_isWrite(this.rt) && U.test(t))
...
var __PRIVATE_DeleteFieldValueImpl = class ___PRIVATE_DeleteFieldValueImpl extends FieldValue {
  _toFieldTransform(t) {
    if (2 !== t.rt)
      throw 1 === t.rt ? t.lt(`${this._methodName}() can only appear at the top level of your update data`) : t.lt(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
function __PRIVATE_parseData(t, e) {
  ...
  return function __PRIVATE_parseScalarValue(t2, e2) {
    ...
    if (t2 instanceof DocumentReference) {
      ...
      if (!n.isEqual(r))
        throw e2.lt(`Document reference is for database ${n.projectId}/${n.database} but should be for database ${r.projectId}/${r.database}`);
      return {
        referenceValue: __PRIVATE_toResourceName(t2.firestore._databaseId || e2.databaseId, t2._key.path)
      };
    }
    throw e2.lt(`Unsupported field value: ${__PRIVATE_valueDescription(t2)}`);
  }(t, e);
}
...
function __PRIVATE_newQueryBoundFromDocOrFields(t, e, r, n) {
  if (r[0] = getModularInstance(r[0]), r[0] instanceof DocumentSnapshot)
    return function __PRIVATE_newQueryBoundFromDocument(t2, e2, r2, n2, i) {
      ...
      const s = [];
      for (const r3 of __PRIVATE_queryOrderBy(t2))
...
var __PRIVATE_TransactionRunner = class {
  ...
  It(t) {
    this.At > 0 && this.Vt(t) ? (this.At -= 1, this.asyncQueue.enqueueAndForget(() => (this.Pt(), Promise.resolve()))) : this.deferred.reject(t);
  }
  Vt(t) {
...
var __PRIVATE_AsyncQueueImpl = class {
  constructor() {
    ...
    this.St = () => {
      ...
      t2 && __PRIVATE_logDebug("AsyncQueue", "Visibility state changed to " + t2.visibilityState), this.Tt.Y();
    };
    const t = getDocument();
